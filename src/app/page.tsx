...
export default function Home() {
  ...
  const bottomElementVariants = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.8, delay: 0.2, ease: [0.19, 1, 0.22, 1] as const },
    },
  };

  useEffect(() => {
    // Memoji and related preloads disabled temporarily
    // const img = new window.Image();
    // img.src = '/nanobanana-photoroom.png';
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pb-10 md:pb-20">
      ...
      {/* header */}
      <motion.div
        className="z-20 mt-24 mb-8 flex flex-col items-center text-center md:mt-4 md:mb-12"
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="z-20 mt-4 flex w-full flex-col items-center justify-center md:px-0"
      >
        {/* free-form question */}
        <form
          onSubmit={(e) => {
